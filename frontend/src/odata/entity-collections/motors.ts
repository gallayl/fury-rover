...
export class Motors {
   ...
   * Custom action 'stop'
   */
  public stop = (entityId: number) => this.getService().execCustomAction('stop', entityId)
  /**
   * Custom action 'getValue'
   */
  public getValue = (entityId: number) => this.getService().execCustomFunction<unknown>('getValue', entityId)
  /**
   * Custom collection action 'stopAll'
   */
  public stopAll = () => this.getService().execCustomCollectionAction('stopAll')
  /**
   * Custom collection action 'getAllValue'
   */
  public getAllValue = () => this.getService().execCustomCollectionFunction<unknown>('getAllValue')
